...
import ClickButton from '../nav/buttons/clickbutton';
import {
  Button_white,
  Head_icon,
  Home_background,
...
import LogoutPopup from '../nav/popup/exit_popup';
import ChoosePlayTime from '../nav/popup/two_button_popup';
import Header from './header';
import {setPlay} from '../../redux/play';
import EndOfPlay from '../nav/popup/one_button_popup';
